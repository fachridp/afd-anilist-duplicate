  ...
  return (
    <>
      <div className={`max-md:fixed max-md:top-[25vh] max-md:left-[5vw] z-10 md:absolute left-0 md:w-full md:top-[4.6rem] ${!isDropdownGenres && 'hidden'}`}>
        ...
        <div className={`bg-background-100 rounded-md overflow-scroll-dropdown-filter overflow-y-auto shadow-md closest-genres-filter max-md:w-[90vw] px-2 ${isDropdownGenres ? 'max-h-[60vh] pb-2' : 'max-h-0'}`}>
