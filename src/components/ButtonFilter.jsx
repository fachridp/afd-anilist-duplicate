...
function ButtonFilter() {
 ...
 return (
  <>
   <button type="button" onClick={handleOpenExtraFilterMedium} className="bg-background-100 rounded-md shadow-md py-[0.6875rem] px-4 cursor-pointer w-[2.8125rem] h-[2.625rem] col-end-12 lg:hidden">
   ...
   <button type="button" onClick={handleOpenExtraFilterLarge} className="bg-background-100 rounded-md shadow-md closest-button-filter-large py-[0.6875rem] px-4 cursor-pointer w-[2.8125rem] h-[2.625rem] col-end-12 hidden lg:block">
