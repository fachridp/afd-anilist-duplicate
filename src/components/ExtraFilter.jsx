...
function ExtraFilter() {
 ...
 return (
  <>
   <div className={`row-start-2 col-start-1 col-end-12 max-lg:overflow-x-scroll w-full max-lg:pb-1 overflow-scroll-wrap snap-x snap-mandatory lg:block md:-mb-96 md:pb-96 ${!isExtraFilterMobile && "hidden"}`}>
