...
function LargeExtraFilter() {
 ...
 return (
  <div className={`flex gap-x-4 items-start closest-button-filter-large lg:bg-background-100 lg:rounded-[0.625rem] lg:shadow-md lg:w-[58rem] lg:flex-col lg:absolute lg:right-0 lg:top-[4.5rem] lg:px-10 lg:pt-8 lg:z-10 ${!isExtraFilterLarge && "lg:hidden"}`}>
